    ...
    return ( 
        <div className="w-full mt-20">
            <div>
                ...
                className="appearance-none w-full mt-2 bg-white border border-gray-400 text-black py-3 px-4 pr-8 rounded leading-none focus:outline-none  focus:boder-gray-500">
            ...
            <div className="mt-4">
                ...
                <label htmlFor="" className="text-lg text-gray-800 mr-2">Proteger con Password:</label>
                <input 
                type="checkbox"
