...
const Dropzone = () => {
    ...
    const onDropRejected = ()=>{
        mostrarAlerta('No se puede subir, el Limite es 1MB, obten una cuenta gratis para subir archivos mas grandes.');
    }
                    ...
                    <input className="h-100" {...getInputProps() }/>
                   ...
                   
                        {
                            ...
                            <div className="text-center">
                                <p className="text-2xl text-center text-gray-600">Selcciona un archivo y arrastralo aqui</p>
                                <button 
                                type="button"
                                className="bg-blue-700 w-full py-3 rounded-lg text-white my-10 hover:bg-blue-800">
